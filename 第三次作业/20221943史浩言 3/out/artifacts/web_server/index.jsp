...
<head>
  ...
  <style>
    ...
    body {
      ...
      background-color: #000; /* 可选：设置背景颜色以对比表单 */
    }
    .form.login-form {
      transform: scale(1.5);
...
<div class="form login-form">
  <div class="form-title"><span>欢迎登录！</span></div>
  <div class="title-2"><span>SPACE</span></div>
  <form action="${pageContext.request.contextPath}/LoginServlet" method="post">
    <div class="input-container">
      <input type="text" name="username" class="input-mail" placeholder="用户名" />
    </div>
    <div class="bg-stars">
    ...
    <div class="input-container">
      <input type="password" name="password" class="input-pwd" placeholder="密码" />
    </div>
  ...
  <p class="signup-link">
    没有账号？
    <a class="up" href="${pageContext.request.contextPath}/register.jsp">注册！</a>
  </p>
</div>
</body>
</html>
